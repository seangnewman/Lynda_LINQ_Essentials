...
namespace Start_LINQ_SQL
{
    ...
    class Program
    {
        ...
        {
            DataContext db = new DataContext(@"C:\Users\Sean\Source\Repos\Lynda)LINQ_Essentials\08_02_SQL_Query_end\Start_LINQ_SQL\LINQ_SQL_DB.mdf"); //You will need fill in the location of the .mdf database file
