...
namespace Start_LINQ_SQL
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DataContext db = new DataContext(@"C:\Users\Sean\Source\Repos\Lynda)LINQ_Essentials\08_02_SQL_Query_start\Start_LINQ_SQL\LINQ_SQL_DB.mdf");


            //Data Source = (LocalDB)\v11.0; AttachDbFilename = C:\Users\Sean\Source\Repos\Lynda)LINQ_Essentials\08_02_SQL_Query_start\Start_LINQ_SQL\LINQ_SQL_DB.mdf; Integrated Security = True
            ...
            var stateQuery = customers
                .Where(customer => customer.State == "OR");


            foreach (var customer in stateQuery)
            {
