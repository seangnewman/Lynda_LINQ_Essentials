    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            //    .Join(distributors, c => c.State, d => d.State, (c, d) => new { custName = c.Last, distName = d.Name });

            var matchupquery = customers
               .GroupJoin(distributors, c => c.State, d => d.State, (c, d) => new { custName = c.Last, distName = d.Select( dist => dist.Name) });
            ...
            foreach (var cd in matchupquery)
            {
                ...
                {
                    Console.WriteLine($"\tDistributor : {dist}");
                }
