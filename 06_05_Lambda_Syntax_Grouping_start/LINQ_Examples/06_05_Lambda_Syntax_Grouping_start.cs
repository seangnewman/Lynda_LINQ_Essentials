    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            foreach (var vipStatus in groupQuery)
            {
                Console.WriteLine($"{vipStatus.Key}");
                foreach (var customer in vipStatus)
                {
                    Console.WriteLine($"{customer.Last}, {customer.First} {customer.Price:C}");
                }
            }
