    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            //var exchangeQuery = customers
            //   .Select(currency => currency.Price * 0.89);

            //var exchangeQuery = customers
            //   .SelectMany(currency => exchange, (c,e) => c.Price * e);

            var purchasesQuery = customers
               .SelectMany(c => c.Purchases)
               ;



            foreach (var purchases in purchasesQuery)
            {
