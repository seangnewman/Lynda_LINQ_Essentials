        ...
        static void Main(string[] args)
        {
            ...
            */            
            ...
            var topEuroQuery =
                ...
                where euro > 500
                orderby c.Last
                select new { lastName = c.Last, totalSpent = c.Price };
            ...
            {
                Console.WriteLine("{0}: {1:N2}", c.lastName, c.totalSpent );
            }

            foreach (var customer in updateQuery)
            {
                Console.WriteLine($"{customer.lastName}, {customer.firstName} : {customer.productName} {customer.totalSpent:C}");
            }
